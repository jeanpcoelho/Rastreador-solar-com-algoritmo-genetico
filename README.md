...
Geração Inicial (População):O AG cria uma população inicial de ângulos aleatórios entre 0° e 180°.<br/>
Cada ângulo representa um possível candidato para a otimização.<br/>
