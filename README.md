...
_Geração Inicial (População):_O AG cria uma população inicial de ângulos aleatórios entre 0° e 180° cada ângulo representa um possível candidato para a otimização.<br/>
